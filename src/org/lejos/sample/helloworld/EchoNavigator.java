...
//        	Button.ENTER.waitForPressAndRelease();
	...
	public void featureDetected(Feature feature, FeatureDetector detector) {
		...
		float currentRange = feature.getRangeReading().getRange();
		
		double currentTravelSpeed = pilot.getTravelSpeed();
		
		
    	System.out.println("Object Detected at: " + currentRange);
		...
		{
			pilot.setTravelSpeed(currentTravelSpeed * 0.5);
		}
